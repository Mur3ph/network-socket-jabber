package main.ie.murph.network.communicator.client;
...
import main.ie.murph.network.communicator.constants.text.IGUIRequest;
import main.ie.murph.network.communicator.constants.text.INetwork;
import main.ie.murph.network.communicator.domain.Login;
import main.ie.murph.network.communicator.domain.message.MessageDefault;
import main.ie.murph.network.communicator.external.api.streams.ObjectStream;

public class GreetingMessageClient {
	private static final Logger LOGGER = LogManager.getLogger(GreetingMessageClient.class.getName());
	...
	public static void main(String[] args) throws ClassNotFoundException {
		new GreetingMessageClient();
	}

	private GreetingMessageClient() throws ClassNotFoundException {
